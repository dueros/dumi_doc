...
ai.dueros.bot.local_service(x)|life_common|生活服务；鲜花、美容、理发、导航、周边、路况|附近堵车么;故宫在哪里;附近的饭馆
ai.dueros.bot.service_general|sac|通用服务入口|我要买火车票
ai.dueros.bot.restaurant_info|restaurant_bot|美食服务|北京哪里的烤鸭好吃
...
ai.dueros.bot.smart_phone_assistant(x)|[phone](bot/phone.md)|电话指令、打开app、网页、通信录、我的位置|
ai.dueros.bot.movie|movie_satisfy|电影|正在上映的电影
ai.dueros.bot.food_delivery|o2o_satisfy|外卖|帮我叫个外卖
ai.dueros.bot.taxi_service|rent_car|打车|我要打车
...
ai.dueros.bot.tv_drama_info|drama_satisfy|电视剧|琅琊榜
ai.dueros.bot.tourism|travel_server|旅游，景点，hi周末|最近有什么演唱会？
ai.dueros.bot.phone_bill|recharge|手机充值（必须登录）|帮我充值话费
...
ai.dueros.bot.speaker_control|[speaker_hardware](bot/speaker_hardware.md)|扬声器控制|声音大一点
ai.dueros.bot.audio_news|audio_news|新闻|英特尔的最新新闻
ai.dueros.bot.music|[audio_music](bot/audio_music.md)|音乐|放一首周杰伦的歌
